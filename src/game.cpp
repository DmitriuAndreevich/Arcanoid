...
,paddle(resources, { static_cast<float>(window_width), static_cast<float>(window_height) })
{
	...
	//ÏÎÄÃÐÓÆÀÒÜ ÈÇ ÔÀÉËÀ HIGH_SCORE
...
void Game::gameLost() {
	...
	//Îáíîâèòüòàáëèöó ëèäåðà highScore
...
//ÇÀÃÐÓÆÀÒÜ Â ÔÀÉË HIGH_SCORE
//ÑÄÅËÀÒÜ ÇÂÓÊ ÑÒÎËÊÍÎÂÅÒÈß ØÀÐÈÊÀ È ÊÈÐÏÈ×ÈÊÀ
